...
- [x] 41-01-PLAN.md — Create the shared CardInjuryBadge module (glyph geometry, derivations, both render modes)
- [x] 41-02-PLAN.md — Extend BenchEntry with yellowCards/injuryCount and populate both engine construction sites
...
- [x] 41-06-PLAN.md — Cross-surface ICON-01 consolidation audit and four-surface consistency spec
...
- [x] 42-01-PLAN.md — shared `isActivePiece` helper + red-card exclusion in moveValidator/passValidator/outOfBounds (BUG-38, Pitfall 7)
...
- [x] 42-11-PLAN.md — bench red-card badge: suppress the duplicate card glyph, keep one indicator (gap item 1)
- [x] 42-12-PLAN.md — chrome: ROSTER label, solid-green strip with white text, action row under the roster, orange Cancel (gap items 2-5)
- [x] 42-13-PLAN.md — free-kick defensive wall: auto-move defenders to the minimum legal distance, remove the silent DEFENDER_TOO_CLOSE dead-end (gap item 7, out-of-phase-scope)
...
- [x] 42-16-PLAN.md — apply isActivePiece to passValidator LONG landing restriction (WR-01) and offside opponent counting/flag evaluation, with regression tests

**Gap-closure Wave 5** _(blocked on Gap-closure Wave 4)_

- [x] 42-17-PLAN.md — exhaustive packages/shared piece-list audit (D-10 item 4 closeout incl. offside.ts) + whole-repo quality gate
...
- [x] 43-01-PLAN.md — shared type surface (TACKLE_STEAL_PROMPT phase, TACKLE_STEAL_DECLINED event, prompt-cluster GameState fields) + tackling-descending defender ordering
...
- [x] 43-06-PLAN.md — TACKLE-03 ring-persistence tests, socket integration for the full sequence, whole-repo gate + live two-browser verification
