...
_Requirements to be defined. Run `/gsd-new-milestone` to begin._

Likely candidates from backlog:

- OFFSIDE-01/02 human UAT verification (code implemented in v1.2; two-tab live test not closed)
- GK_KICK replay frame visibility (REPLAY_ELIGIBLE_TYPES gap)
- KICK_OFF_SETUP stale shot-path hex shading (root cause unknown)
