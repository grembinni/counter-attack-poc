...
- [x] 08.2-02-PLAN.md — Engine applyRoll PASS branch: per-type accuracy, ball delivery, interception loop, LOOSE_BALL trajectory walk (PASS-01/02/03/05)
...
- [x] 08.2-04-PLAN.md — Server handlers: GAME_ROLL targetHex validation + interception dice, GAME_HEADER_CONTESTANT, HEADER confirm guard (PASS-01..05)

**Wave 5** _(blocked on Wave 4 completion)_

- [x] 08.2-05-PLAN.md — Client: three-step PASS flow, green/amber target highlights, header contestant UI (PASS-01..05)
