...
- [x] 39-23-PLAN.md — Penalty-taker select-and-confirm UX and shoot-only restart (UAT gap 6)
- [x] 39-24-PLAN.md — Tackle-from-behind rule and distinct Action Log entry (UAT gap 7)
...
- [x] 40-01-PLAN.md — Shared substitution contracts: STOPPAGE_PHASES allow-list, GameState bench/subsUsed/addedTimeBonus, SUBSTITUTION event + per-event-type registration
...
- [x] 40-07-PLAN.md — Two-client substitution integration test + two-browser human verification checkpoint
