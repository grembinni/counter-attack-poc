...
- truth: "ThrowInSetupPanel shows only necessary/helpful text"
  ...
  severity: cosmetic
  test: 2
  root_cause: "ThrowInSetupPanel.tsx's throwing-manager branch renders a redundant '<span className={styles.constraintRow}>Throw-In!</span>' at line 79, directly beneath the 'Throw-In' heading (line 77) and above the actionable instruction 'Select a player to take the throw.' (line 80) — it duplicates the heading and adds no new information."
  artifacts:
