...
const CLIP_X = HEX_SIZE * 0.5; // left at 120°/240° corners of q=0 hexes (not the left tip)
const CLIP_Y = HEX_SIZE * SQRT3 * 0.5;
const CLIP_W = HEX_SIZE * 1.5 * 36 + HEX_SIZE; // right at 60°/300° corners (1110) of q=36
