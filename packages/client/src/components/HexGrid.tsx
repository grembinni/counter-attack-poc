...
const CLIP_X = 0; // left boundary at 180° tip of q=0 hexes (leftmost point)
const CLIP_Y = HEX_SIZE * SQRT3 * 0.5;
const CLIP_W = HEX_SIZE * 1.5 * 36 + HEX_SIZE * 1.5; // 1110 — right boundary at 1110 (60°/300° corners of q=36)
