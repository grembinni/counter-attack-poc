...
export function PieceOverlay({
  ...
  return (
    <>
      ...
      {/* CARD-02/INJURY-02/INJURY-03 (D-04/D-05): card and injury badges anchored at the
          NEGATED ball-dot offset. dotOffsetY is always +PIECE_RADIUS*0.715 and dotOffsetX
          flips sign by teamId, so negating both lands the badge in the corner opposite
