...
export const FORMATIONS = {
  '4-4-2': {
    ...
    slots: [
      ...
      { slotId: 'RM', slotRole: 'MID-wing', position: { q: 12, r: 5 }, jerseyNumber: 7 },
      ...
      { slotId: 'LM', slotRole: 'MID-wing', position: { q: 12, r: 21 }, jerseyNumber: 11 },
  ...
  '5-3-2': {
    ...
    slots: [
      { slotId: 'GK', slotRole: 'GK', position: { q: 2, r: 13 }, jerseyNumber: 1 },
      { slotId: 'RB', slotRole: 'DEF-back', position: { q: 10, r: 4 }, jerseyNumber: 2 },
      { slotId: 'RCB', slotRole: 'DEF-center', position: { q: 6, r: 8 }, jerseyNumber: 4 },
      { slotId: 'CB', slotRole: 'DEF-center', position: { q: 6, r: 13 }, jerseyNumber: 6 },
      { slotId: 'LCB', slotRole: 'DEF-center', position: { q: 6, r: 18 }, jerseyNumber: 5 },
      { slotId: 'LB', slotRole: 'DEF-back', position: { q: 10, r: 22 }, jerseyNumber: 3 },
      { slotId: 'RCM', slotRole: 'MID-central', position: { q: 12, r: 7 }, jerseyNumber: 8 },
      { slotId: 'CM', slotRole: 'MID-central', position: { q: 10, r: 13 }, jerseyNumber: 7 },
      { slotId: 'LCM', slotRole: 'MID-central', position: { q: 12, r: 19 }, jerseyNumber: 11 },
      { slotId: 'RF', slotRole: 'FWD-wing', position: { q: 14, r: 9 }, jerseyNumber: 10 },
      { slotId: 'ST', slotRole: 'FWD-central', position: { q: 14, r: 17 }, jerseyNumber: 9 },
    ] as readonly FormationSlot[],
  },
  '4-3-3': {
    ...
    slots: [
      ...
      { slotId: 'LCM', slotRole: 'MID-central', position: { q: 12, r: 19 }, jerseyNumber: 7 },
      { slotId: 'RF', slotRole: 'FWD-wing', position: { q: 14, r: 7 }, jerseyNumber: 10 },
  ...
  '3-4-3': {
    ...
    slots: [
      { slotId: 'GK', slotRole: 'GK', position: { q: 2, r: 13 }, jerseyNumber: 1 },
      { slotId: 'RB', slotRole: 'DEF-back', position: { q: 8, r: 7 }, jerseyNumber: 2 },
      { slotId: 'CB', slotRole: 'DEF-center', position: { q: 6, r: 13 }, jerseyNumber: 4 },
      { slotId: 'LB', slotRole: 'DEF-back', position: { q: 8, r: 19 }, jerseyNumber: 3 },
      { slotId: 'RM', slotRole: 'MID-wing', position: { q: 12, r: 5 }, jerseyNumber: 7 },
      { slotId: 'RCM', slotRole: 'MID-central', position: { q: 10, r: 10 }, jerseyNumber: 6 },
      { slotId: 'LCM', slotRole: 'MID-central', position: { q: 10, r: 16 }, jerseyNumber: 8 },
      { slotId: 'LM', slotRole: 'MID-wing', position: { q: 12, r: 21 }, jerseyNumber: 11 },
